...
public class ShulkerBoxItemInventory implements IInventory, INamedContainerProvider {
    ...
    public void openInventory(PlayerEntity player) {
        player.world.playSound(null, player.getPosX(), player.getPosY(), player.getPosZ(), AdvancedShulkerBoxTileEnitity.getOpenSound(), SoundCategory.BLOCKS, 0.5F, player.world.rand.nextFloat() * 0.1F + 0.9F);
    }

    @Override
    public void closeInventory(PlayerEntity player) {
        player.world.playSound(null, player.getPosX(), player.getPosY(), player.getPosZ(), AdvancedShulkerBoxTileEnitity.getCloseSound(), SoundCategory.BLOCKS, 0.5F, player.world.rand.nextFloat() * 0.1F + 0.9F);
    }
